...
ZIP_NAME=todolist-backend.tar.gz
...
if [ -f "/tmp/todolist/todolist-backend.tar.gz" ]; then
    echo "Found file /tmp/todolist/todolist-backend.tar.gz in the target server. Will start the deploy..."
